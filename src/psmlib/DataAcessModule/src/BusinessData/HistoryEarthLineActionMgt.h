...
#ifndef __HISTORYEARTHLINEACTION__H
#define __HISTORYEARTHLINEACTION__H
...
#define MAX_HISTORYEARTHLINEACTION_COUNT 200							//最大地线数量

class CHistoryEarthLineActionMgt : public CBusinessDataSet
{
public:
    CHistoryEarthLineActionMgt();
    ~CHistoryEarthLineActionMgt();

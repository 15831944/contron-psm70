...
#ifndef __TICKETACTIONLISTMGT__H
#define __TICKETACTIONLISTMGT__H
...
#define MAX_TICKETACTIONLIST_COUNT 200							//最大操作票动作表数量

class CTicketActionListMgt : public CBusinessDataSet
{
public:
	CTicketActionListMgt();
	~CTicketActionListMgt();
    ...
    int delRDataAction(DWORD32 ticketID);

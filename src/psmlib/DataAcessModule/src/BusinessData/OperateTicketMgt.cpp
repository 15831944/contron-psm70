...
作者：李施施 2014-07-22
**************************************************************************************************/
COperateTicketMgt::COperateTicketMgt()
{
	m_count = 0;
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::retrieve()
{
	...
	int loadCount = 0;
	m_count = 0;
    const char *sql = "SELECT * FROM t_operateticket ";
...
作者：佘佳明  2014-09-12
**************************************************************************************************/
int COperateTicketMgt::retrieve_DESC()
{
    if(!m_isInit)		return -2;
    ...
    int loadCount = 0;
    m_count = 0;
    const char *sql = "SELECT * FROM t_operateticket ORDER BY ID DESC";
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::retrieve( const DWORD32 ID )
{
	if(!m_isInit)		return -2;
    ...
    const char *sql = "SELECT * FROM t_operateticket where ID=:f<unsigned int>";
...
作者：刘高舜 2014-09-10
**************************************************************************************************/
int COperateTicketMgt::retrieveByID(const DWORD32 ID)
{
    if(!m_isInit)		return -2;
    ...
    const char *sql = "SELECT * FROM t_operateticket where stationID=:f<unsigned int>";
...
作者：刘高舜 2014-08-29
**************************************************************************************************/
int COperateTicketMgt::retrieveByStationID( const DWORD32 ID )
{
	if(!m_isInit)		return -2;
...
作者：李施施 2014-8-7
**************************************************************************************************/
int COperateTicketMgt::retrieveByType( const DWORD32 type )
{
	if(!m_isInit)		return -2;
    ...
    const char *sql = "SELECT * FROM t_operateticket where type=:f<unsigned int>";
...
作者：佘佳明  2014-9-12
**************************************************************************************************/
int COperateTicketMgt::retrieveByType_DESC( const DWORD32 type )
{
    if(!m_isInit)		return -2;
    ...
    const char *sql = "SELECT * FROM t_operateticket where type=:f<unsigned int> ORDER BY ID DESC";
...
作者：佘佳明  2014-9-12
**************************************************************************************************/
int COperateTicketMgt::retrieveByTicketID(const DWORD32 ID)
{
    if(!m_isInit)		return -2;
...
作者：佘佳明  2014-11-17
**************************************************************************************************/
int COperateTicketMgt::retrieveByStationIDAndTypeOrderByDate_DESC(const DWORD32 ID, const DWORD32 type)
{
    if(!m_isInit)		return -2;
    ...
    const char *sql = "SELECT * FROM t_operateticket where stationID=:f1<unsigned int> AND type=:f2<unsigned int> ORDER BY makeTicketTime DESC";
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::add( TOperateTicket *pInputParam )
{
	if(!m_isInit)	return -2;
    ...
    sprintf(sql,"insert into t_operateticket values(NULL,           \
            :f1_stationID<unsigned int>,                            \
            :f2_name<char[255]>,                                    \
            :f3_number<unsigned int>,                               \
            :f4_person<char[16]>,                                   \
             '%s',                                                  \
             ...
             '%s',                                                  \
             :f14_begin<unsigned int>,                              \
             :f15_end<unsigned int>,                                \
             :f16_auditState<unsigned int>,                         \
             :f17_operater<unsigned int>,                           \
             :f18_gua<unsigned int>,                                \
             :f19_manager<unsigned int>,                            \
             :f20_sendunit<char[16]>,                               \
             :f21_sendp<char[64]>,                                  \
             :f22_recvu<char[64]>,                                  \
             :f23_recvp<char[16]>,                                  \
             :f24<unsigned int>)",                                  \
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::del( const DWORD32 ID )
{
	if(!m_isInit)	return -2;
	...
	const char *sql = "DELETE FROM t_operateticket WHERE ID = :f1_ID<unsigned int>";
	try
	{
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::update( const DWORD32 ID, TOperateTicket *pInputParam )
{
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::add2List( TOperateTicket *pInputParam )
{
	if(NULL == pInputParam)		return -1;
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::delFromList( const DWORD32 ID )
{
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::isIDExist( const DWORD32 ID )
{
	int index = -1;
...
作者：李施施 2014-07-21
**************************************************************************************************/
int COperateTicketMgt::getMoreMemory()
{
...
作者：李施施 2014-07-29
**************************************************************************************************/
int COperateTicketMgt::getListCount()
{
	return m_count;
}
...
作者：李施施 2014-07-29
**************************************************************************************************/
TOperateTicket * COperateTicketMgt::getListByIndex( DWORD32 index )
{
...
作者：李施施 2014-07-30
**************************************************************************************************/
int COperateTicketMgt::updateList( const DWORD32 ID, const TOperateTicket *pInputParam )
{
	if(NULL == pInputParam)		return -1;

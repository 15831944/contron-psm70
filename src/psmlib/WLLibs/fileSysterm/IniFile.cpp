...
#include <stdlib.h>
#include <string.h>
//#include <conio.h>	// Only for test: Used :  kbhit //修改 叶文林 注释之 因为这个文件在 QT+wince下找不到
#include "IniFile.h"
#include <string.h>
//#define INIFILE_TEST_THIS_FILE //修改 叶文林 因为 不需这个main
...
//修改 叶文林 强行去掉条件编译，因为QT + wince下也没有这个函数原型
